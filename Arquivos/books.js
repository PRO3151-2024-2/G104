...
async function populateBookDetails() {
    ...
    if (book) {
        ...
        document.getElementById('book-cover').src = `http://localhost/PRO3151/Lab12/${book.capa}.jpg`;  // Atribui o caminho da capa ao elemento de imagem
        ...
        document.getElementById('book-cover').onerror = function() {    // Verifica se a imagem falhou ao carregar e exibe uma imagem alternativa se necessário
            this.src = 'http://localhost/PRO3151/Lab12/capas/default.jpg'; // Caminho de uma imagem padrão (adicionar)
